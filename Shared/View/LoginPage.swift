        ...
        VStack{
            ...
            ScrollView(.vertical, showsIndicators: false) {
                ...
                VStack(spacing: 15){
                    ...
                    Text(loginData.registerUser ? "Войти" : "Регистрация")
                        .font(.custom(customFont, size: 22).bold())
                        .frame(maxWidth: .infinity,alignment: .leading)
                    
                    // Custom Text Field...
                    
                    CustomTextField(icon: "envelope", title: "Почта", hint: "ersultan@gmail.com", value: $loginData.email, showPassword: .constant(false))
                        .padding(.top,30)
                    
                    CustomTextField(icon: "lock", title: "Пароль", hint: "123456", value: $loginData.password, showPassword: $loginData.showPassword)
                        .padding(.top,10)
                    ...
                    Button {
                        ...
                        Text(loginData.registerUser ? "Back to login" : "Создать аккаунт")
                            .font(.custom(customFont, size: 14))
                            .fontWeight(.semibold)
                            .foregroundColor(Color("Purple"))
                    }
